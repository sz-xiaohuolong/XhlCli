...
public final class JavaCodeSearchEngine implements CodeSearchEngine {
    ...
    public JavaCodeSearchEngine() {
        this(DEFAULT_EXCLUDED_DIRS);
    }

    public JavaCodeSearchEngine(Set<String> excludedDirs) {
    ...
    public CodeSearchResult search(CodeSearchRequest request) {
        ...
        try {
            Path searchRoot = request.root() != null ? request.root() : request.projectRoot();
