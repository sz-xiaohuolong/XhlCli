...
| 优先级 | 阶段 | 状态 | 交付目标 |
|---|---|---|---|
| P0 | [Phase 00](docs/prd/phase-00-project-foundation.md) | 已实现，发布验证中 | Java 21 工程、CLI 元信息、测试与 CI 基线 |
| P0 | [Phase 01](docs/prd/phase-01-terminal-chat.md) | 设计完成 | 流式终端对话与首个模型 Provider |
